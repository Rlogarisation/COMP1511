...
//These are the straight lines of numbers, 
//with the first number coming from the line before
//There are 4 cases to deal with each line based on which direction 
//it would go when spiraling inwards
//(For the example below 'r' is for lines going right, 
//'d' for lines going down, 'u' for lines going up and 'l' for lines going left)
//eg.
// rrrrr
// ----d
// urr-d
